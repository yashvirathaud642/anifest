...
<!-- Mirrored from codeskdhaka.com/html/expovent-prev/expovent/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 06:53:09 GMT -->
<head>
   <meta charset="utf-8">
                           ...
                           <div class="card__header-dropdown">
                              <div class="dropdown">
                                 ...
                                 <div class="dropdown-list">
                                    <a class="dropdown__item" href="{{ url("javascript:void(0)") }}">Edit</a>
                                    <a class="dropdown__item" href="{{ url("javascript:void(0)") }}">Delete</a>
                                 </div>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="card__inner">
                        <div class="card-body">
                           <div class="news__item">
                              <div class="news__item-inner">
                                 <div class="news__thumb">
                                    <a href="{{ url("schedule-list.html") }}"><img src="{{ asset("/assets/img/blog/meta/01.png") }}" alt="image not found"></a>
                                 </div>
                                 <div class="news__content">
                                    <h4 class="news__title"><a href="{{ url("schedule-list.html") }}">Digital Business Summit - 2023</a></h4>
                           ...
                           <div class="news__item">
                              <div class="news__item-inner">
                                 <div class="news__thumb">
                                    <a href="{{ url("schedule-list.html") }}"><img src="{{ asset("/assets/img/blog/meta/02.png") }}" alt="image not found"></a>
                                 </div>
                                 <div class="news__content">
                                    <h4 class="news__title"> <a href="{{ url("schedule-list.html") }}">NASA Space Apps Challenge Summit - 2023</a></h4>
                                    <div class="news__meta">
                                       <div class="news__meta-status">
                                          <span><i class="flaticon-user"></i></span>
                                          <span>Andru Hebo</span>
                           ...
                           <div class="news__item">
                              <div class="news__item-inner">
                                 <div class="news__thumb">
                                    <a href="{{ url("schedule-list.html") }}"> <img src="{{ asset("/assets/img/blog/meta/03.png") }}" alt="image not found"></a>
                                 </div>
                                 <div class="news__content">
                                    <h4 class="news__title"> <a href="{{ url("schedule-list.html") }}">Digital Product Design & Interaction Seminar - 2023</a></h4>
                                    <div class="news__meta">
                                       <div class="news__meta-status">
                                          <span><i class="flaticon-user"></i></span>
                                          <span>Andru Hebo</span>
                           ...
                           <div class="tab-pane fade show active" id="tricke-1" role="tabpanel"
                              ...
                              <div class="tricket__sold-item">
                                 <div class="news__item-inner bb-0">
                                    <div class="news__thumb">
                                       <a href="{{ url("event-list.html") }}">
                                          <img src="{{ asset("/assets/img/blog/meta/01.png") }}" alt="image not found">
                                       </a>
                                    </div>
                                    <div class="news__content">
                                       <h4 class="news__title"> <a href="{{ url("event-list.html") }}">Digital Business Summit - 2023</a></h4>
                                       <div class="news__meta">
                                          <div class="news__meta-status">
                                             <span><i class="flaticon-user"></i></span>
                                             <span>Andru Hebo</span>
                              ...
                              <div class="tricket__sold-item">
                                 <div class="news__item-inner bb-0">
                                    <div class="news__thumb">
                                       <a href="{{ url("event-list.html") }}"><img src="{{ asset("/assets/img/blog/meta/02.png") }}" alt="image not found"></a>
                                    </div>
                                    <div class="news__content">
                                       <h4 class="news__title"> <a href="{{ url("event-list.html") }}">NASA Space Apps Challenge Summit - 2023</a></h4>
                                       <div class="news__meta">
                                          <div class="news__meta-status">
                                             <span><i class="flaticon-user"></i></span>
                                             <span>Andru Hebo</span>
                              ...
                              <div class="tricket__sold-item">
                                 <div class="news__item-inner bb-0">
                                    <div class="news__thumb">
                                       <a href="{{ url("event-list.html") }}">
                                          <img src="{{ asset("/assets/img/blog/meta/03.png") }}" alt="image not found">
                                       </a>
                                    </div>
                                    <div class="news__content">
                                       <h4 class="news__title"> <a href="{{ url("event-list.html") }}">Digital Product Design & Interaction Seminar - 2023</a></h4>
                                       <div class="news__meta">
                                          <div class="news__meta-status">
                                             <span><i class="flaticon-user"></i></span>
                                             <span>Andru Hebo</span>
                              ...
                              <div class="tricket__sold-item">
                                 <div class="news__item-inner bb-0">
                                    <div class="news__thumb">
                                       <a href="{{ url("event-list.html") }}">
                                          <img src="{{ asset("/assets/img/blog/meta/02.png") }}" alt="image not found">
                                       </a>
                                    </div>
                                    <div class="news__content">
                                       <h4 class="news__title"> <a href="{{ url("event-list.html") }}">Digital Product Design & Interaction Seminar - 2023</a></h4>
                              ...
                              <div class="tricket__sold-item">
                                 <div class="news__item-inner bb-0">
                                    <div class="news__thumb">
                                       <a href="{{ url("event-list.html") }}"><img src="{{ asset("/assets/img/blog/meta/03.png") }}" alt="image not found"></a>
                                    </div>
                                    <div class="news__content">
                                       <h4 class="news__title"> <a href="{{ url("event-list.html") }}">Digital Business Summit - 2023</a></h4>
                                       <div class="news__meta">
               ...
               <div class="card__wrapper">
                  <div class="card__header">
                     <div class="card__header-top mb-30">
                        ...
                        <div class="card__header-right">
                           <div class="card__btn">
                              <a href="{{ url("speaker-list.html") }}">view all Speaker</a>
                           </div>
                           <div class="card__header-dropdown">
                              <div class="dropdown">
                                 <button>
                                 ...
                                 <div class="speaker__info">
                                    <div class="speaker__thumb">
                                       <a href="{{ url("event-details.html") }}">
                                          <img src="{{ asset("/assets/img/speaker/meta/01.png") }}" alt="image not found">
                                       </a>
                                    </div>
                                    <div class="speaker__content">
                                       <h5 class="speaker__title"><a href="{{ url("event-details.html") }}">Harry Porter</a></h5>
                                       <span class="speaker__status">Digital Marketer</span>
                                    </div>
                                 </div>
                                 <div class="speaker__button">
                                    <a href="{{ url("event-details.html") }}"><i class="fa-regular fa-angle-right"></i></a>
                                 </div>
                              </div>
                           </div>
                           <div class="speaker__item">
                              <div class="speaker__inner">
                                 <div class="speaker__info">
                                    <div class="speaker__thumb">
                                       <a href="{{ url("event-details.html") }}">
                                          <img src="{{ asset("/assets/img/speaker/meta/02.png") }}" alt="image not found">
                                       </a>
                                    </div>
                                    <div class="speaker__content">
                                       <h5 class="speaker__title"><a href="{{ url("event-details.html") }}">Alex Don Smith</a></h5>
                           ...
                           <div class="speaker__item">
                              <div class="speaker__inner">
                                 <div class="speaker__info">
                                    <div class="speaker__thumb">
                                       <a href="{{ url("event-details.html") }}">
                                          <img src="{{ asset("/assets/img/speaker/meta/03.png") }}" alt="image not found">
                                       </a>
                                    </div>
                                    <div class="speaker__content">
                                       <h5 class="speaker__title"><a href="{{ url("event-details.html") }}">Lilyen Demi</a></h5>
                           ...
                           <div class="speaker__item">
                              <div class="speaker__inner">
                                 <div class="speaker__info">
                                    <div class="speaker__thumb">
                                       <a href="{{ url("event-details.html") }}">
                                       <img src="{{ asset("/assets/img/speaker/meta/04.png") }}" alt="image not found">
                                       </a>
                                    </div>
                                    <div class="speaker__content">
                                       <h5 class="speaker__title"><a href="{{ url("event-details.html") }}">Lilyen Demi</a></h5>
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td>
                                 <div class="attendant__user-item">
                                    <div class="registration__user-thumb">
                                       <img src="{{ asset("/assets/img/user/1/01.png") }}" alt="image not found">
                                    </div>
                              ...
                              <td>
                                 <div class="attendant__seminer">
                                    <span><a href="{{ url("event-details.html") }}">Digital Product Design Seminar - 2023</a></span>
                                 </div>
                              </td>
                              <td>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="attendant__user-item">
                                    <div class="registration__user-thumb">
                                       <img src="{{ asset("/assets/img/user/1/02.png") }}" alt="image not found">
                                    </div>
                                    <div class="attendant__user-title">
                                       <span>Lary go</span>
                                    </div>
                              ...
                              <td>
                                 <div class="attendant__seminer">
                                    <span class="status"><a href="{{ url("event-details.html") }}">Graphic Design Innovation Seminar- 2023</a></span>
                                 </div>
                              </td>
                              <td>
                                 <div class="attendant__time">
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="attendant__user-item">
                                    <div class="registration__user-thumb">
                                       <img src="{{ asset("/assets/img/user/1/03.png") }}" alt="image not found">
                                    </div>
                                    <div class="attendant__user-title">
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="attendant__user-item">
                                    <div class="registration__user-thumb">
                                       <img src="{{ asset("/assets/img/user/1/04.png") }}" alt="image not found">
                                    </div>
                                    <div class="attendant__user-title">
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="attendant__user-item">
                                    <div class="registration__user-thumb">
                                       <img src="{{ asset("/assets/img/user/1/05.png") }}" alt="image not found">
                                    </div>
                                    <div class="attendant__user-title">
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="attendant__user-item">
                                    <div class="registration__user-thumb">
                                       <img src="{{ asset("/assets/img/user/1/06.png") }}" alt="image not found">
                                    </div>
                                    <div class="attendant__user-title">
                              ...
                              <td>
                                 <div class="attendant__seminer">
                                    <span><a href="{{ url("event-details.html") }}">Product & Interaction Seminar - 2023</a></span>
                                 </div>
                              </td>
                              <td>
                                 <div class="attendant__time">
               ...
               <div class="card__wrapper">
                  <div class="card__header">
                     <div class="card__header-top">
                        ...
                        <div class="card__header-right">
                           <div class="card__btn">
                              <a href="{{ url("event-details.html") }}">view all Event</a>
                           </div>
                           <div class="card__header-dropdown">
                              <div class="dropdown">
                                 <button>
                     ...
                     <div class="scroll-w-4 card__scroll">
                        <div class="card__inner">
                           <div class="news__item">
                              <div class="news__item-inner">
                                 <div class="news__thumb">
                                    <a href="{{ url("event-details.html") }}"><img src="{{ asset("/assets/img/blog/meta/01.png") }}" alt="image not found"></a>
                                 </div>
                                 <div class="news__content">
                                    <h4 class="news__title"><a href="{{ url("event-details.html") }}">Digital Business Summit - 2023</a></h4>
                                    <div class="news__meta">
                                       <div class="news__meta-status">
                                          <span><i class="flaticon-user"></i></span>
                                          <span>Andru Hebo</span>
                           ...
                           <div class="news__item">
                              <div class="news__item-inner">
                                 <div class="news__thumb">
                                    <a href="{{ url("event-details.html") }}"><img src="{{ asset("/assets/img/blog/meta/02.png") }}" alt="image not found"></a>
                                 </div>
                                 <div class="news__content">
                                    <h4 class="news__title"><a href="{{ url("event-details.html") }}">NASA Space Apps Challenge Summit - 2023</a></h4>
                                    <div class="news__meta">
                                       <div class="news__meta-status">
                                          <span><i class="flaticon-user"></i></span>
                                          <span>Andru Hebo</span>
                           ...
                           <div class="news__item">
                              <div class="news__item-inner">
                                 <div class="news__thumb">
                                    <a href="{{ url("event-details.html") }}"><img src="{{ asset("/assets/img/blog/meta/03.png") }}" alt="image not found"></a>
                                 </div>
                                 <div class="news__content">
                                    <h4 class="news__title"><a href="{{ url("event-details.html") }}">Digital Product Design & Interaction Seminar - 2023</a></h4>
                                    <div class="news__meta">
                                       <div class="news__meta-status">
                                          <span><i class="flaticon-user"></i></span>
                                          <span>Andru Hebo</span>
...
<!-- Mirrored from codeskdhaka.com/html/expovent-prev/expovent/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 06:53:39 GMT -->
</html>
