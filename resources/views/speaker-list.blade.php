...
<!-- Mirrored from codeskdhaka.com/html/expovent-prev/expovent/speaker-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 06:54:09 GMT -->
<head>
      <meta charset="utf-8">
               ...
               <div class="breadcrumb__wrapper mb-35">
                  <div class="breadcrumb__main">
                     ...
                     <div class="breadcrum__button">
                        <a class="breadcrum__btn speaker__popup-active" href="{{ url("#") }}">Add Speaker<i class="fa-regular fa-plus"></i></a>
                     </div>
                  </div>
               </div>
            </div>
                        ...
                        <div class="row">
                              ...
                              <div class="speaker__list-item mb-30">
                                 <div class="speaker__list-thumb">
                                    <a href="{{ url("profile.html") }}">
                                       <img src="{{ asset("/assets/img/speaker/list/01.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                                 <div class="speaker__list-content-inner">
                                    <div class="speaker__list-content">
                                       <h5 class="speaker__author-title"><a href="{{ url("profile.html") }}">David Warner</a></h5>
                           ...
                           <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                              <div class="speaker__list-item mb-30">
                                 <div class="speaker__list-thumb">
                                    <a href="{{ url("profile.html") }}">
                                       <img src="{{ asset("/assets/img/speaker/list/02.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                                 <div class="speaker__list-content-inner">
                                    <div class="speaker__list-content">
                                       <h5 class="speaker__author-title"><a href="{{ url("profile.html") }}">Linda M. Norris</a></h5>
                           ...
                           <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                              <div class="speaker__list-item mb-30">
                                 <div class="speaker__list-thumb">
                                    <a href="{{ url("profile.html") }}">
                                       <img src="{{ asset("/assets/img/speaker/list/03.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                                 <div class="speaker__list-content-inner">
                                    <div class="speaker__list-content">
                                       <h5 class="speaker__author-title"><a href="{{ url("profile.html") }}">Bruce S. Smith</a></h5>
                           ...
                           <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                              <div class="speaker__list-item mb-30">
                                 <div class="speaker__list-thumb">
                                    <a href="{{ url("profile.html") }}">
                                       <img src="{{ asset("/assets/img/speaker/list/04.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                                 <div class="speaker__list-content-inner">
                                    <div class="speaker__list-content">
                                       <h5 class="speaker__author-title"><a href="{{ url("profile.html") }}">Michael K. Crockett</a></h5>
                           ...
                           <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                              <div class="speaker__list-item mb-30">
                                 <div class="speaker__list-thumb">
                                    <a href="{{ url("profile.html") }}">
                                       <img src="{{ asset("/assets/img/speaker/list/05.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                                 <div class="speaker__list-content-inner">
                                    <div class="speaker__list-content">
                                       <h5 class="speaker__author-title"><a href="{{ url("profile.html") }}">Betty D. Lucas</a></h5>
                           ...
                           <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                              <div class="speaker__list-item mb-30">
                                 <div class="speaker__list-thumb">
                                    <a href="{{ url("profile.html") }}">
                                       <img src="{{ asset("/assets/img/speaker/list/06.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                                 <div class="speaker__list-content-inner">
                                    <div class="speaker__list-content">
                                       <h5 class="speaker__author-title"><a href="{{ url("profile.html") }}">Joseph R. Robinson</a></h5>
                           ...
                           <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                              <div class="speaker__list-item mb-30">
                                 <div class="speaker__list-thumb">
                                    <a href="{{ url("profile.html") }}">
                                       <img src="{{ asset("/assets/img/speaker/list/07.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                                 <div class="speaker__list-content-inner">
                                    <div class="speaker__list-content">
                                       <h5 class="speaker__author-title"><a href="{{ url("profile.html") }}">Nicolas N. Smith</a></h5>
                           ...
                           <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                              <div class="speaker__list-item mb-30">
                                 <div class="speaker__list-thumb">
                                    <a href="{{ url("profile.html") }}">
                                       <img src="{{ asset("/assets/img/speaker/list/08.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                                 <div class="speaker__list-content-inner">
                                    <div class="speaker__list-content">
                                       <h5 class="speaker__author-title"><a href="{{ url("profile.html") }}">Christine A. Thomas</a></h5>
                           ...
                           <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                              <div class="speaker__list-item mb-30">
                                 <div class="speaker__list-thumb">
                                    <a href="{{ url("profile.html") }}">
                                       <img src="{{ asset("/assets/img/speaker/list/09.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                                 <div class="speaker__list-content-inner">
                                    <div class="speaker__list-content">
                                       <h5 class="speaker__author-title"><a href="{{ url("profile.html") }}">Drew P. Bad</a></h5>
...
<!-- Mirrored from codeskdhaka.com/html/expovent-prev/expovent/speaker-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 06:54:11 GMT -->
</html>
