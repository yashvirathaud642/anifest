...
<!-- Mirrored from codeskdhaka.com/html/expovent-prev/expovent/event-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 06:54:12 GMT -->
<head>
      <meta charset="utf-8">
               ...
               <div class="breadcrumb__wrapper mb-35">
                  <div class="breadcrumb__main">
                     ...
                     <div class="breadcrum__button">
                        <a class="breadcrum__btn event__popup-active" href="{{ url("#") }}">Create Event<i class="fa-regular fa-plus"></i></a>
                     </div>
                  </div>
               </div>
            </div>
                                       ...
                                       <td>
                                          <div class="attendant__speakers">
                                             <div class="attendant__speakers-thumb">
                                                <img src="{{ asset("/assets/img/meta/01.png") }}" alt="image not found">
                                                <img src="{{ asset("/assets/img/meta/02.png") }}" alt="image not found">
                                                <img src="{{ asset("/assets/img/meta/03.png") }}" alt="image not found">
                                                <img src="{{ asset("/assets/img/meta/04.png") }}" alt="image not found">
...
<!-- Mirrored from codeskdhaka.com/html/expovent-prev/expovent/event-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 06:54:14 GMT -->
</html>
