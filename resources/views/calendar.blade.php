...
<!-- Mirrored from codeskdhaka.com/html/expovent-prev/expovent/calendar.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 06:54:14 GMT -->
<head>
      <meta charset="utf-8">
       ...
       <div class="offcanvas__wrapper">
           <div class="offcanvas__content">
               ...
               <div class="offcanvas__search mb-25">
                  <form action="{{ route('search') }}" method="GET"> <!-- Replace 'search' with your actual route name -->
                      <input type="text" name="query" placeholder="What are you searching for?"> <!-- 'query' is the name of the input field -->
              ...
              <div class="offcanvas__contact mt-30 mb-20">
               ...
               <ul>
                   ...
                   <li class="d-flex align-items-center">
                       ...
                       <div class="offcanvas__contact-text">
                           <a href="{{ url("mailto:support@mail.com") }}">support@mail.com</a>
                       </div>
                   </li>
               </ul>
           </div>
...
<section class="event__popup-area">
   <div class="popup__wrapper">
       ...
       <div class="popup__input-wrapper">
           <form action="{{ route('add.attendant') }}" method="POST" enctype="multipart/form-data">
               @csrf
               <div class="singel__input-field mb-15">
               ...
               <div class="popup__update">
                   <label class="input__field-text">Upload Image (200x200px)</label>
                   <input type="file" name="attendant_image" accept="image/*">
               </div>
