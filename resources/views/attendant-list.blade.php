...
<!-- Mirrored from codeskdhaka.com/html/expovent-prev/expovent/attendant-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 06:54:11 GMT -->
<head>
   <meta charset="utf-8">
               ...
               <div class="offcanvas__top mb-40 d-flex justify-content-between align-items-center">
                   <div class="offcanvas__logo">
                       <a href="{{ url("{{ url('dashboard') }}") }}">
                           <img src="{{ asset("/{{ asset('assets/img/logo/logo-black.svg') }}") }}" alt="logo not found">
                       </a>
                   </div>
               ...
               <div class="offcanvas__contact mt-30 mb-20">
                   ...
                   <ul>
                       ...
                       <li class="d-flex align-items-center">
                           ...
                           <div class="offcanvas__contact-text">
                               <a href="{{ url("mailto:support@mail.com") }}"><span>support@mail.com</span></a>
                           </div>
                       </li>
                   </ul>
               </div>
   ...
   <div class="popup__wrapper">
      ...
      <div class="popup__input-wrapper">
         <form action="#">
            ...
            <button class="input__btn w-100" type="submit"><i class="fa-regular fa-plus"></i>Add Attendant</button>
         </form>
      </div>
   </div>
</section>
...
<div class="expovent__sidebar" data-background="{{ asset('assets/img/bg/dropdown-bg.png') }}">
   <div class="logo-details">
      <span>
         <a href="{{ url("{{ url('dashboard') }}") }}">
            <img class="logo__white" src="{{ asset("/{{ asset('assets/img/logo/logo-small.svg') }}") }}" alt="logo not found">
         </a>
      </span>
      <span>
         <a href="{{ url("{{ url('dashboard') }}") }}">
            <img class="log__smnall" src="{{ asset("/{{ asset('assets/img/logo/logo.svg') }}") }}" alt="logo not found">
         </a>
      </span>
   </div>
         ...
         <ul class="metismenu" id="menu">
            <li><a class="has-arrow" href="{{ url("javascript:void(0)") }}" aria-expanded="false">
               ...
               <ul aria-expanded="false">
                  <li><a href="{{ url("{{ url('dashboard') }}") }}">Dashboard</a></li>
                  <li><a href="{{ url("{{ url('landing-page') }}") }}">Landing Page</a></li>
                  <li><a href="{{ url("{{ url('element') }}") }}">UI Elements</a></li>
               </ul>
            </li>
            <li><a href="{{ url("{{ url('schedule-list') }}") }}" aria-expanded="false">
                  <i class="flaticon-calendar-1"></i>
                  <span class="nav-text">Schedule List</span>
               </a>
            </li>
            <li><a href="{{ url("{{ url('speaker-list') }}") }}" aria-expanded="false">
                  <i class="flaticon-speaker"></i>
                  <span class="nav-text">Speaker List</span>
               </a>
            </li>
            <li><a href="{{ url("{{ url('attendant-list') }}") }}" aria-expanded="false">
            ...
            <li><a class="has-arrow" href="{{ url("javascript:void(0)") }}" aria-expanded="false">
               ...
               <span class="nav-text">Upcoming Event</span>
            </a>
            <ul aria-expanded="false">
               <li><a href="{{ url("{{ url('create-event') }}") }}">Create Event</a></li>
               <li><a href="{{ url("{{ url('event-list') }}") }}">Event List</a></li>
               <li><a href="{{ url("{{ url('event-details') }}") }}">Event Details</a></li>
            </ul>
            </li>
            <li><a href="{{ url("{{ url('calendar') }}") }}" aria-expanded="false">
                  <i class="flaticon-calendar"></i>
                  <span class="nav-text">Calendar</span>
               </a>
            </li>
            <li><a href="{{ url("{{ url('venue') }}") }}" aria-expanded="false">
            ...
            <ul aria-expanded="false">
               <li><a href="{{ url("{{ url('profile') }}") }}">Profile</a></li>
               <li><a href="{{ url("{{ url('setting') }}") }}">Setting</a></li>
               <li><a href="{{ url("{{ url('chat') }}") }}">Chatbox</a></li>
               <li><a href="{{ url("{{ url('signin') }}") }}">Sign in</a></li>
               <li><a href="{{ url("{{ url('signup') }}") }}">Sign up</a></li>
            </ul>
            </li>
         </ul>
         <div class="sidebar__thumb mb-60 mt-50">
            <a href="{{ url("#") }}">
               <img src="{{ asset("/{{ asset('assets/img/sidebar/sidebar.jpg') }}") }}" alt="image not found">
            </a>
         </div>
         <div class="sidebar__profile mb-50">
            <a href="{{ url("{{ url('signin') }}") }}"><i class="flaticon-log-out-3"></i><span class="links_name">Log out</span></a>
         </div>
       ...
       <ul>
           <li>
               <div class="nav-item p-relative">
                   <a id="langdropdown" class="langdropdown" href="{{ url("{{ route('your.route.name') }}") }}">
                       <span>
               ...
               <div class="breadcrumb__wrapper mb-35">
                  <div class="breadcrumb__main">
                     ...
                     <div class="breadcrum__button">
                        <a class="breadcrum__btn event__popup-active" href="{{ url("#") }}">Add New Attendy<i class="fa-regular fa-plus"></i></a>
                     </div>
                  </div>
               </div>
            </div>
                              ...
                              <table>
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <div class="attendant__seminer">
                                             <span><a href="{{ url("event-details.html") }}">Graphic Design Innovation Seminar- 2023</a></span>
                                          </div>
                                       </td>
                                       <td>
                                          <div class="attendant__time">
