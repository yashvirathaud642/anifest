...
<!-- Mirrored from codeskdhaka.com/html/expovent-prev/expovent/venue.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 06:54:14 GMT -->
<head>
      <meta charset="utf-8">
                           ...
                           <div class="event__venue-thumb">
                              ...
                              <div class="event__tag-post">
                                 <div class="event__tag-item">
                                    <span><a href="{{ url("#") }}">Hall 01</a></span>
                                 </div>
                                 <div class="event__tag-item">
                                    <span><a href="{{ url("#") }}">20 Seat Available</a></span>
                                 </div> 
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                     <div class="event__venue-card mb-20">
                        <div class="event__venue-inner">
                           ...
                           <div class="event__venue-thumb">
                              <a href="{{ url("#") }}">
                                 <img src="{{ asset("/assets/img/venue/venue-02.jpg") }}" alt="image not found">
                              </a>
                              <div class="event__tag-post">
                                 <div class="event__tag-item">
                                    <span><a href="{{ url("#") }}">Hall 05</a></span>
                                 </div>
                                 <div class="event__tag-item">
                                    <span><a href="{{ url("#") }}">100 Seat Available</a></span>
                                 </div> 
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                     <div class="event__venue-card mb-20">
                        <div class="event__venue-inner">
                           ...
                           <div class="event__venue-thumb">
                              <a href="{{ url("#") }}">
                                 <img src="{{ asset("/assets/img/venue/venue-03.jpg") }}" alt="image not found">
                              </a>
                              <div class="event__tag-post">
                                 <div class="event__tag-item">
                                    <span><a href="{{ url("#") }}">Hall 08</a></span>
                                 </div>
                                 <div class="event__tag-item">
                                    <span><a href="{{ url("#") }}">160 Seat Available</a></span>
                                 </div> 
                              </div>
                           </div>
                        </div>
...
<!-- Mirrored from codeskdhaka.com/html/expovent-prev/expovent/venue.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 06:54:15 GMT -->
</html>
