                           ...
                           <div class="event__update-wrapper">
                              ...
                              <div class="event__update-file">
                                 <div class="event__update-thumb">
                                    <img src="{{ asset("/assets/img/event/update/update-thumb-01.png") }}" alt="image not found">
                                    <span class="update__thumb-close"><i class="fa-regular fa-xmark"></i></span>
                                 </div>
                                 <div class="event__update-thumb">
                                    <img src="{{ asset("/assets/img/event/update/update-thumb-02.png") }}" alt="image not found">
                                    <span class="update__thumb-close"><i class="fa-regular fa-xmark"></i></span>
                                 </div>
                                 <div class="event__update-thumb">
