            ...
            <div class="sign__left">
               <div class="sign__header">
                  ...
                  <div class="sign__link">
                     <a class="sign__link-active" href="{{ route ('signin') }}">Sign in</a>
                     <a class="sign__link-text" href="{{ route ('signup') }}">Sign Up</a>
                  </div>
               </div>
                  ...
                  <div class="sign__input-form text-center">
                     <form action="#">
                        <div class="sign__input">
                           ...
                           <input id="email" type="email" placeholder="Enter register email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        ...
                        <div class="sing__button mb-20">
                           ...
                           <button type="submit" class="input__btn w-100 mb-20">
                              {{ __('signin') }}
                          </button>
