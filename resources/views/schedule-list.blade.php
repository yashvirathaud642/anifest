...
<!-- Mirrored from codeskdhaka.com/html/expovent-prev/expovent/schedule-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 06:54:05 GMT -->
<head>
   <meta charset="utf-8">
               ...
               <div class="breadcrumb__wrapper mb-35">
                  <div class="breadcrumb__main">
                     ...
                     <div class="breadcrum__button">
                        <a class="breadcrum__btn" href="{{ url("create-event.html") }}">Create Event<i
                           ...
                           <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                              <div class="schedule__blog-item mb-30">
                                 <div class="schedule__content">
                                    ...
                                    <h5 class="schedule__blog-title"><a href="{{ url("event-list.html") }}">Nasa Space Apps Challenge kicks off in Bangladesh</a></h5>
                                 ...
                                 <div class="schedule__blog-thumb w-img">
                                    <div class="schedule__tag-post">
                                       <div class="event__tag-item">
                                          <span><a href="{{ url("event-details.html") }}">Hall 03</a></span>
                                       </div>
                                       <div class="event__tag-item">
                                          <span><a href="{{ url("event-details.html") }}">10 Seat Available</a></span>
                                       </div>
                                    </div>
                                    <div class="schedule__meta-thumb">
                                       <img src="{{ asset("/assets/img/meta/schedule/01.png") }}" alt="image not found">
                                       <img src="{{ asset("/assets/img/meta/schedule/02.png") }}" alt="image not found">
                                       <img src="{{ asset("/assets/img/meta/schedule/03.png") }}" alt="image not found">
                                       <img src="{{ asset("/assets/img/meta/schedule/04.png") }}" alt="image not found">
                                       <div class="">
                                          <span class="schedule__meta-count">02+</span>
                                       </div>
                                    </div>
                                    <a href="{{ url("event-details.html") }}">
                                       <img src="{{ asset("/assets/img/blog/schedule/01.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                              </div>
                           </div>
                           <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                              <div class="schedule__blog-item mb-30">
                                 <div class="schedule__content">
                                    ...
                                    <h5 class="schedule__blog-title"><a href="{{ url("event-list.html") }}">Business event processing
                                 ...
                                 <div class="schedule__blog-thumb w-img">
                                    <div class="schedule__tag-post">
                                       ...
                                       <div class="event__tag-item">
                                          <span><a href="{{ url("event-details.html") }}">06 Seat Available</a></span>
                                       </div>
                                    </div>
                                    <div class="schedule__meta-thumb">
                                       <img src="{{ asset("/assets/img/meta/schedule/01.png") }}" alt="image not found">
                                    ...
                                    <a href="{{ url("event-details.html") }}">
                                       <img src="{{ asset("/assets/img/blog/schedule/02.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                              </div>
                           </div>
                           <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                              <div class="schedule__blog-item mb-30">
                                 <div class="schedule__content">
                                    ...
                                    <h5 class="schedule__blog-title"><a href="{{ url("event-list.html") }}">Transaction Processing
                                 ...
                                 <div class="schedule__blog-thumb w-img">
                                    <div class="schedule__tag-post">
                                       ...
                                       <div class="event__tag-item">
                                          <span><a href="{{ url("event-details.html") }}">04 Seat Available</a></span>
                                       </div>
                                    </div>
                                    <div class="schedule__meta-thumb">
                                       <img src="{{ asset("/assets/img/meta/schedule/01.png") }}" alt="image not found">
                                    ...
                                    <a href="{{ url("event-details.html") }}">
                                       <img src="{{ asset("/assets/img/blog/schedule/03.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                              </div>
                           </div>
                           <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                              <div class="schedule__blog-item mb-30">
                                 <div class="schedule__content">
                                    ...
                                    <h5 class="schedule__blog-title"><a href="{{ url("event-list.html") }}">Providing data for
                                 ...
                                 <div class="schedule__blog-thumb w-img">
                                    <div class="schedule__tag-post">
                                       ...
                                       <div class="event__tag-item">
                                          <span><a href="{{ url("event-details.html") }}">15 Seat Available</a></span>
                                       </div>
                                    </div>
                                    <div class="schedule__meta-thumb">
                                       <img src="{{ asset("/assets/img/meta/schedule/01.png") }}" alt="image not found">
                                    ...
                                    <a href="{{ url("event-details.html") }}">
                                       <img src="{{ asset("/assets/img/blog/schedule/04.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                              </div>
                           </div>
                           <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                              <div class="schedule__blog-item mb-30">
                                 <div class="schedule__content">
                                    ...
                                    <h5 class="schedule__blog-title"><a href="{{ url("event-list.html") }}">Facilitating quick
                                 ...
                                 <div class="schedule__blog-thumb w-img">
                                    <div class="schedule__tag-post">
                                       ...
                                       <div class="event__tag-item">
                                          <span><a href="{{ url("event-details.html") }}">20 Seat Available</a></span>
                                       </div>
                                    </div>
                                    <div class="schedule__meta-thumb">
                                       <img src="{{ asset("/assets/img/meta/schedule/01.png") }}" alt="image not found">
                                    ...
                                    <a href="{{ url("event-details.html") }}">
                                       <img src="{{ asset("/assets/img/blog/schedule/05.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="schedule__blog-item mb-30">
                                 ...
                                 <div class="schedule__blog-thumb w-img">
                                    <div class="schedule__tag-post">
                                       ...
                                       <div class="event__tag-item">
                                          <span><a href="{{ url("event-details.html") }}">18 Seat Available</a></span>
                                       </div>
                                    </div>
                                    <div class="schedule__meta-thumb">
                                       <img src="{{ asset("/assets/img/meta/schedule/01.png") }}" alt="image not found">
                                    ...
                                    <a href="{{ url("event-details.html") }}">
                                       <img src="{{ asset("/assets/img/blog/schedule/06.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                              </div>
                           </div>
                           <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                              <div class="schedule__blog-item mb-30">
                                 <div class="schedule__content">
                                    ...
                                    <h5 class="schedule__blog-title"><a href="{{ url("event-list.html") }}">An enrichment program
                                          gathers
                                 ...
                                 <div class="schedule__blog-thumb w-img">
                                    <div class="schedule__tag-post">
                                       ...
                                       <div class="event__tag-item">
                                          <span><a href="{{ url("event-details.html") }}">08 Seat Available</a></span>
                                       </div>
                                    </div>
                                    <div class="schedule__meta-thumb">
                                       <img src="{{ asset("/assets/img/meta/schedule/01.png") }}" alt="image not found">
                                    ...
                                    <a href="{{ url("event-details.html") }}">
                                       <img src="{{ asset("/assets/img/blog/schedule/07.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                              </div>
                           </div>
                           <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                              <div class="schedule__blog-item mb-30">
                                 <div class="schedule__content">
                                    ...
                                    <h5 class="schedule__blog-title"><a href="{{ url("event-list.html") }}">The business event
                                          dispatch queue is a
                                 ...
                                 <div class="schedule__blog-thumb w-img">
                                    ...
                                    <a href="{{ url("event-details.html") }}">
                                       <img src="{{ asset("/assets/img/blog/schedule/08.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                              </div>
                           </div>
                           <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                              <div class="schedule__blog-item mb-30">
                                 <div class="schedule__content">
                                    ...
                                    <h5 class="schedule__blog-title"><a href="{{ url("event-list.html") }}">The purpose of the
                                          dispatch queue is
                                 ...
                                 <div class="schedule__blog-thumb w-img">
                                    <div class="schedule__tag-post">
                                       ...
                                       <div class="event__tag-item">
                                          <span><a href="{{ url("event-details.html") }}">16 Seat Available</a></span>
                                       </div>
                                    </div>
                                    <div class="schedule__meta-thumb">
                                       <img src="{{ asset("/assets/img/meta/schedule/01.png") }}" alt="image not found">
                                    ...
                                    <a href="{{ url("event-details.html") }}">
                                       <img src="{{ asset("/assets/img/blog/schedule/09.jpg") }}" alt="image not found">
                                    </a>
                                 </div>
                              </div>
                           </div>
...
<!-- Mirrored from codeskdhaka.com/html/expovent-prev/expovent/schedule-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 06:54:09 GMT -->
</html>