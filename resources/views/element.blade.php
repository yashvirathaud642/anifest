...
<!-- Mirrored from codeskdhaka.com/html/expovent-prev/expovent/element.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 06:54:05 GMT -->
<head>
   <meta charset="utf-8">
                           ...
                           <div class="butttons__element-wrapper mt-35">
                              <div class="button__grid-wrapper">
                                 <div class="fill__button-inner">
                                    <a class="element__btn red-bg" href="{{ url("#") }}">Home</a>
                                    <a class="element__btn perple-bg" href="{{ url("#") }}">Home</a>
                                    <a class="element__btn yellow-bg" href="{{ url("#") }}">Home</a>
                                    <a class="element__btn pink-bg" href="{{ url("#") }}">Home</a>
                                    <a class="element__btn blue-bg" href="{{ url("#") }}">Home</a>
                                    <a class="element__btn green-bg" href="{{ url("#") }}">Home</a>
                                 </div>
                                 <div class="border__button-inner">
                                    <a class="element__btn border-red" href="{{ url("#") }}">Home</a>
                                    <a class="element__btn border-perple" href="{{ url("#") }}">Home</a>
                                    <a class="element__btn border-yellow" href="{{ url("#") }}">Home</a>
                                    <a class="element__btn border-pink" href="{{ url("#") }}">Home</a>
                                    <a class="element__btn border-blue" href="{{ url("#") }}">Home</a>
                                    <a class="element__btn border-green" href="{{ url("#") }}">Home</a>
                                 </div>
                              </div>
                           </div>
                        </div>
